...
class UserInterfaceController extends Controller
{
    ...
    public function sendCodeOrder(Request $request)
    {
        ...
        Notification::send(Admin::get()->first(), new AdminOrder($user->email, $product->product_name, 'شراء'));
    ...
    public function sendChargeOrder(Request $request)
    {
        ...
        Notification::send(Admin::get()->first(), new AdminOrder($user->email, $product->name, 'شحن'));
